...
HRESULT DefinePackageDependency_Muffins()
{
    ...
    RETURN_IF_FAILED(L"muffins", SavePackageDependencyId(packageDependencyId.get()));
    return S_OK;
}
...
HRESULT DefinePackageDependency_Waffles()
{
    ...
    RETURN_IF_FAILED(L"waffles", SavePackageDependencyId(packageDependencyId.get()));
    return S_OK;
}
...
HRESULT DeletePackageDependencyIds()
{
    ...
    // so we only need to delete the package dependency ids we saved when we pinned the package depednencies
